...
const LETTER_SPEED = 25; // ms per char for title
const TYPE_SPEED = 15; // ms per char for description
const CTA_FADE = 300; // ms for CTA to appear
const CTA_PULSE = 800; // ms for underline extend + retract
const CARD_GAP = 200; // ms between cards
