...
**Read `READMEFIRST.md` before doing anything.** It points you to all the key documents: PRD, design authority, status tracker, and project management files. Tell the user you've read it and summarise the current state before starting work.
...
- **Contact form:** Google Apps Script → email + Google Sheet (complete)
- **Analytics:** Google Analytics GA4 (Phase 22, not started)
